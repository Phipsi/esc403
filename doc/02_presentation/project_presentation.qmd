...
Residual mean squared error : `r round(lasso_hardbrucke_rmse,2)`
:::
...
Residual mean squared error : `r round(nb_hardbrücke_rmse,2)`
:::
...
-   Most importan variables are *hour of day* (`time`) the temperature (`T [°C]`) day of the week (`weekday`), `month`, *relative humidity* (\`Hr \[%Hr\]) and the lagged values.
